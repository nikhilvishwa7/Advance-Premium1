...
◆ ᴅᴇᴠs 2​ : <a href='https://t.me/kcrazyprincessbot'>ʀᴏʙᴏᴛ</a></b>"""
...
• /deletefiles - <code>Tᴏ ᴅᴇʟᴇᴛᴇ CᴀᴍRɪᴘ ᴀɴᴅ PʀᴇDVD Fɪʟᴇs ғʀᴏᴍ ᴛʜᴇ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ.</code>"""
    ...
    LOG_TEXT_G = """#NewGroup #jerry
Group = {}(<code>{}</code>)
Total Members = <code>{}</code>
Added By - {}
"""

    LOG_TEXT_P = """#NewUser #jerry
ID - <code>{}</code>
Nᴀᴍᴇ - {}
"""
    ALRT_TXT = """ʜᴇʟʟᴏ {},
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @snfilmy"""
...
𝖤𝗑𝖺𝗆𝗉𝗅𝖾 :- <code>/country India</code>"""
    ...
    LRX_TXT = """<b><u>lyrics ɪɴғᴏ</b></u>
<b>Tʜɪs ᴍᴏᴅᴜʟᴇ ɪs ᴛᴏ ғɪɴᴅ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ lyrics</b>
• /lyrics [song name] 
𝖤𝗑𝖺𝗆𝗉𝗅𝖾 :- <code>/lyrics India</code>"""
    
    GENR_TXT = """<b>Genrate Password</b>
• /genpw
• /genpassword

here is your password genrator"""
