...
ɴᴏᴡ ɪᴛs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ᴋᴇᴇᴘ sᴜᴘᴘᴏʀᴛ. ᴀᴅᴅ ɪᴛ sᴏᴏɴ​ ❤️"""
    ...
    TUTORIAL_TXT = """<b>
🦋 🦋 🦋 🦋 🦋 🦋 🦋 🦋 \n\n➥ ᴛᴏ ᴇᴀʀɴ ᴍᴏɴᴇʏ ᴡɪᴛʜ ᴛʜᴇ ʜᴇʟᴘ ᴏꜰ ɪᴍᴅʙ ʙᴏᴛ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ “<a href='tg://settings'>𝘾𝙡𝙞𝙘𝙠 𝙃𝙚𝙧𝙚 𝙩𝙤 𝙒𝙖𝙩𝙘𝙝</a>” ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.\n\n©️ @Crazybotz</b>"""
...
⚠️ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 5 ᴍɪɴᴜᴛᴇs.
