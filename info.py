...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6249148586').split()]
...
STREAM_URL = environ.get("STREAM_URL", "https://crazybotz-shivam31635.koyeb.app/") # https://example.com/ (Your Stream Url)
