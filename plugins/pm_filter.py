...
async def pm_text(bot, message):
    ...
    kk = await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/J_shree_ram")],[InlineKeyboardButton("🧑‍💻  ʙᴏᴛ ᴏᴡɴᴇʀ ", url=f"https://t.me/+SULp-Vs1vlljM2Rl")]])
    )
    await asyncio.sleep(60)
    await kk.delete()
